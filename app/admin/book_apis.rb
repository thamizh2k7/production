...
ActiveAdmin.register BookApi do
    ...
    CSV.parse(csvfile) do |row|
	  ...
	  redirect_to "/ab_admin/books"
  end
  action_item :only => [:index] do
    link_to('Get Book Details',book_details_form_ab_admin_book_apis_path())
  end
  action_item :only => [:index] do
    link_to('Update Book Details',finalize_book_form_ab_admin_book_apis_path())
  end
end
