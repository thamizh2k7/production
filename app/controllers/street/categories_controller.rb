class Street::CategoriesController < ApplicationController
 ...
 layout :p2p_layout
  ...
  def create
    ...
    respond_to do |format|
      if @p2p_category.save
                 ...
                 redirect_to street_categories_url, notice: 'Category was successfully created.'
                 return
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to street_categories_url }
      format.json { head :no_content }
    end
  end
