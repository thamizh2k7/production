class Street::ProductsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @p2p_product.save
        ...
        redirect_to street_products_url, notice: 'Product was successfully created.'
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to street_products_url }
      format.json { head :no_content }
    end
  end
end
